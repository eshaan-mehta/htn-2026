...
local ledt, kw, sub, sn, L, god = 0, 1, nil, -1 -- god: toggled by every flip of the AUX1 side switch
...
local function place(m, now)
  ...
  if m == 2 and god then a.dmg, a.stk, a.bp = 200, 1, 0 end -- god mode: AI starts at 200%, one stock, never blocks
  st, ct, cn = m, now, -1
  hudup(c)
  frame()
end
